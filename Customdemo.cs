...
using static Array.CustomDeveloperAttribute;
...
namespace Array
{
    ...
    [Developer(101, "Siva", status = "In Progress --> Class")]
    [Developer(102, "Arun", status = "Completed --> Class")]
    public class Employee11
    {
        [Developer(102, "Arun", status = "Completed --> Property")]
        public int age { get; set; }

        [Developer(101, "Siva", status = "In Progress --> Constructor")]
        public Employee11(int age)
        {
            this.age = age;
        }

        [Developer(101, "Siva", status = "In Progress --> Method1")]
        public void Display1()
        {
            Console.WriteLine("I am a Developer");
        }
        [Developer(102, "Arun", status = "Completed --> Method2")]
